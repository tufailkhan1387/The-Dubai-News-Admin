...
export default function SubCategoryAdsSection() {
    const { apiData, reFetch } = useFetch("/admin/subCategorygetAllAds");
    ...
    const handleConfirmDelete = async () => {
        try {
            setDeleting(true);
            const res = await PostApi("/admin/subCategorydeleteAd", { id: deleteAdId });
    ...
    const handleSubmitAd = async () => {
        ...
        try {
            ...
            const endpoint = isEditMode
                ? `/admin/subCategoryeditAd/${editAdId}`
                : "/admin/subCategoryaddAd";
