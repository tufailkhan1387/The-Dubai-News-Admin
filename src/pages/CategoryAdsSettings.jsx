...
export default function CategoryAdsSettings() {
    const { apiData, reFetch } = useFetch("/admin/categorygetAllAds");
    ...
    const handleConfirmDelete = async () => {
        try {
            setDeleting(true);
            const res = await PostApi("/admin/categorydeleteAd", { id: deleteAdId });
