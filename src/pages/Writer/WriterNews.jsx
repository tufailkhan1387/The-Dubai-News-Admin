...
export default function WriterNews() {
  const navigate = useNavigate();
  const { apiData, reFetch } = useFetch("/admin/writergetAllNews");
  ...
  const statusOptions = ["draft", "publish", "preview"];
  ...
  const EditNews = (id) => {
    navigate("/writer-edit-news", { state: { id: id } });
  };
